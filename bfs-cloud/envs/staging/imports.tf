import {
  to = module.bfs_infrastructure.apps["frontend-staging"].azurerm_container_app.this
...
import {
  to = module.bfs_infrastructure.apps["backend-staging"].azurerm_container_app.this
