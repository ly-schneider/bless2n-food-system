...
- Secret‑Namen u. a.: `mongo-uri`, `jwt-priv-pem`, `jwt-pub-pem`, `station-qr-secret`, `google-client-secret`, `stripe-secret-key`, `stripe-webhook-secret`, `smtp-password`.
- Apps referenzieren KV‑Secrets über Container Apps `key_vault_secrets` oder `key_vault_secret_refs`; Hostnamen/URLs werden aus Terraform-Domains direkt als Environment Variablen gesetzt.
