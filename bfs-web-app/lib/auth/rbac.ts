...
const ROLE_PERMISSIONS: Record<UserRole, Set<Permission>> = {
  ...
  admin: new Set<Permission>([
    ...
    "pos:access", "pos:orders:create", "pos:payments",
    "station:access", "station:verify", "station:redeem",
    "admin:access", "products:write", "orders:read:all",
    "orders:export", "orders:status:write", "categories:write",
    "menus:write", "stations:manage", "pos:manage",
    "users:read", "users:role:set", "devices:approve",
    "devices:revoke", "invites:manage",
  ]),
}
