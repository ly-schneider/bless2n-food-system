...
type PaymentMethodData = { method: string; label: string; count: number }
...
export function PaymentMethodsChart({ data, loading }: { data: PaymentMethodData[]; loading: boolean }) {
              ...
              <PieChart>
                <ChartTooltip
                  content={({ active, payload }) => {
                    ...
                    const d = payload[0].payload as PaymentMethodData
