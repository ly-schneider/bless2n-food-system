...
export default function CheckoutClient() {
  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      >
        <h2 className="mb-4 text-2xl">Warenkorb</h2>
        ...
        <div>
          {cart.items.length === 0 ? (
            ...
            <div className="divide-border mt-4 -mb-5 flex flex-col divide-y [&>*]:py-5 [&>*:first-child]:pt-0">
              {(() => {
      ...
      <div ref={footerRef} className="bg-background fixed right-0 bottom-0 left-0 z-50 p-4">
        <div className="mx-auto flex max-w-xl flex-col gap-3">
          ...
          {cart.items.length > 0 && error && <p className="text-sm text-red-600">{error}</p>}
        </div>
      </div>
