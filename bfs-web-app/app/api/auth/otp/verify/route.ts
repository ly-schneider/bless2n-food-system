...
export async function POST(req: Request) {
  ...
  const data = await res.json() as { access_token: string; expires_in: number; user: unknown; token_type: string; refresh_token?: string; csrf_token?: string; roles?: string[]; is_new?: boolean }
