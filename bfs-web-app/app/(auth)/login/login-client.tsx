                  ...
                  <span className="inline-flex items-center justify-center gap-[10px]">
                    ...
                    >
                      <svg viewBox="0 0 48 48" width="18" height="18">
                        <path
                          fill="#FFC107"
                          d="M43.6 20.5H42V20H24v8h11.3C34.3 32.9 29.7 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3 0 5.7 1.1 7.7 3l5.7-5.7C33.9 6.1 29.2 4 24 4 16 4 9.2 8.6 6.3 14.7z"
                        />
                        <path
                          fill="#FF3D00"
