...
func (h *Handlers) GetStation(w http.ResponseWriter, r *http.Request, stationId string) {
	station, err := h.stations.GetStationByID(r.Context(), stationId)
	if err != nil {
		writeEntError(w, err)
		return
	}
...
func (h *Handlers) ListStationProducts(w http.ResponseWriter, r *http.Request, stationId string) {
	ctx := r.Context()

	// Get the station to verify it exists and load its product assignments.
	station, err := h.stations.GetStationByID(ctx, stationId)
	if err != nil {
		writeEntError(w, err)
		return
	}
...
func (h *Handlers) SetStationProducts(w http.ResponseWriter, r *http.Request, stationId string) {
...
func (h *Handlers) RemoveStationProduct(w http.ResponseWriter, r *http.Request, stationId string, productId string) {
	if err := h.stations.RemoveStationProduct(r.Context(), stationId, productId); err != nil {
		writeEntError(w, err)
		return
	}
...
func (h *Handlers) AddStationProduct(w http.ResponseWriter, r *http.Request, stationId string, productId string) {
...
func (h *Handlers) RenameStation(w http.ResponseWriter, r *http.Request, stationId string) {
	...
	station, err := h.stations.RenameStation(r.Context(), stationId, name)
	if err != nil {
		writeEntError(w, err)
		return
	}
...
func (h *Handlers) RevokeStation(w http.ResponseWriter, r *http.Request, stationId string) {
	if err := h.devices.Revoke(r.Context(), stationId); err != nil {
		writeEntError(w, err)
		return
	}
	w.WriteHeader(http.StatusNoContent)
